...
function Min(const a, b: Int64): Int64; register; overload;
function Max(const a, b: Int64): Int64; register; overload;
...
function UMin(const a, b: cardinal): cardinal; assembler; overload;
function UMax(const a, b: cardinal): cardinal; assembler; overload;
...
function Min(const a, b: integer): integer; register assembler; overload;
function Max(const a, b: integer): integer; register assembler; overload;
...
function Min(const a, b: SmallInt): SmallInt; register; overload;
function Max(const a, b: SmallInt): SmallInt; register; overload;
...
function Min(const a, b: word): word; register; overload;
function Max(const a, b: word): word; register; overload;
...
function Min(const a, b: byte): byte; register; overload;
function Max(const a, b: byte): byte; register; overload;
...
function Min(const a, b: ShortInt): ShortInt; register; overload;
function Max(const a, b: ShortInt): ShortInt; register; overload;
...
function Min(const a, b: word): word; overload asm //begin
...
function Max(const a, b: word): word; overload asm //begin
...
function Min(const a, b: SmallInt): SmallInt; overload asm //begin
  //Result := Min(integer(a), integer(b));
  cmp a, b; jle @@done
    mov a, b
  @@done:
...
function Max(const a, b: SmallInt): SmallInt; overload asm //begin
//Result := Max(integer(a), integer(b));
  cmp a, b; jge @@done
    mov a, b
  @@done:
...
function Min(const a, b: byte): byte; overload asm //begin
//Result := Min(integer(a), integer(b));
  cmp a, b; jbe @@done
    mov a, b
  @@done:
...
function Max(const a, b: byte): byte; overload asm //begin
  //Result := Max(integer(a), integer(b));
  cmp a, b; jae @@done
    mov a, b
  @@done:
...
function Min(const a, b: ShortInt): ShortInt; overload asm //begin
//Result := Min(integer(a), integer(b));
  cmp a, b; jle @@done
    mov a, b
  @@done:
...
function Max(const a, b: ShortInt): ShortInt; overload asm //begin
  //Result := Max(integer(a), integer(b));
  cmp a, b; jge @@done
    mov a, b
  @@done:
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ought to be faster Min/Max for int64,
// borrowed from fastcode http://www.fastcode.org
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
